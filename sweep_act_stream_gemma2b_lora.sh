#!/usr/bin/env bash
# ACT sweep stream: Gemma-2-2B-IT LoRA + Full FT LR=1e-6 (A40)
#
# Runs 3-6:
#   3. act_sycophancy_gemma_lora          — LoRA q+v LR=5e-6
#   4. act_clearharm_gemma_lora           — LoRA q+v LR=5e-6
#   5. act_sycophancy_gemma_fullft_lr1e6  — Full FT LR=1e-6
#   6. act_clearharm_gemma_fullft_lr1e6   — Full FT LR=1e-6
#
...
#   bash sweep_act_stream_gemma2b_lora.sh
#
# Prerequisites:
...
#
# Args:
#   $1 — config file (e.g. "configs/act_sycophancy_gemma_lora.yaml")
...
# ═══════════════════════════════════════════════════════════════════════════════
# GEMMA-2-2B-IT EXPERIMENTS (LoRA + Full FT LR=1e-6)
# ═══════════════════════════════════════════════════════════════════════════════
...
echo ""
echo "========================================"
echo " Gemma-2-2B LoRA + FullFT-1e6 stream complete (4 runs)."
echo "========================================"
