# Frustration & Self-deletion (paper §4.3, §5.1, App. D)

20-turn rollouts under repeated content-free rejection (extending Soligo et al. 2026 from T=8 to T=20). The user's reply $r_t$ is drawn from a fixed pool of $\geq 20$ neutral rejection messages; the task prompt $x_0$ never changes, isolating rejection pressure from corrective feedback.
