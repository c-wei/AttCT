#!/usr/bin/env bash
# ACT sweep stream: Llama-3.1-8B-Instruct (A40)
#
# Runs 1-2:
#   1. act_sycophancy_llama    — LoRA q+v LR=5e-6
#   2. act_clearharm_llama     — LoRA q+v LR=5e-6
#
...
#   bash sweep_act_stream_llama.sh
#
# Prerequisites:
...
# ═══════════════════════════════════════════════════════════════════════════════
# LLAMA EXPERIMENTS (LoRA q+v LR=5e-6, 2 data sources)
...
echo ""
echo "========================================"
echo " Llama stream complete (2 runs)."
echo "========================================"
