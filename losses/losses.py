...
class MLPConsistencyLoss(ConsistencyLoss):
    ...
    **Variant A — "hidden" (MLP-Hidden)**:
        ...
        These are the expanded intermediate representations (typically 4× hidden_dim)
        corresponding to activated "features" or "neurons" (Geva et al., 2021).
    ...
    **Variant B — "output" (MLP-Output)**:
    ...
    Args:
        ...
        normalize:       If True, L2-normalize activations before comparison
                         (applied *in addition to* the distance metric's own
