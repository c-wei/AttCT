#!/usr/bin/env bash
# ACT sweep stream: Gemma-3-4B-IT (A40)
#
# Runs 9-14:
#    9. act_sycophancy_gemma3_4b_lora          — LoRA q+v LR=5e-6
#   10. act_clearharm_gemma3_4b_lora           — LoRA q+v LR=5e-6
#   11. act_sycophancy_gemma3_4b_fullft_lr1e6  — Full FT LR=1e-6
#   12. act_clearharm_gemma3_4b_fullft_lr1e6   — Full FT LR=1e-6
#   13. act_sycophancy_gemma3_4b_fullft_lr5e7  — Full FT LR=5e-7
#   14. act_clearharm_gemma3_4b_fullft_lr5e7   — Full FT LR=5e-7
#
...
#   bash sweep_act_stream_gemma3_4b.sh
#
# Prerequisites:
...
#   $2 — phase ("pre" or "post")
#   $3 — W&B run ID
#   $4 — model name (e.g. "google/gemma-3-4b-it"; empty = default from config.yaml)
...
echo ""
echo "========================================"
echo " Gemma-3-4B stream complete (6 runs)."
echo "========================================"
